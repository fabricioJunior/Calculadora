...
public class Fatorial extends Operações {
    ...
    /**
     * Construto padrão para definir atributo operação como não binaria e o nome
     * da operação(/ Divisão)
     */
    public Fatorial() {
    ...
    /**
     * Definindo operação não binaria que recebe um número qualquer e efetua a
     * operação de fatorial
     *
     * @param num1 String que possui caracteres númericos
